...
class NAFNet(nn.Module):
    def __init__(
        ...
        self.aid_head1 = Track1Head(in_channel=3, embed_dim=layer_width, stride=1)
        ...
        for i, num in enumerate(enc_blk_nums):
            ...
            self.aid_heads.append(Track1Head(in_channel=chan, embed_dim=2 * chan, stride=2))
...
class Track1Head(nn.Module):
    def __init__(self, embed_dim, in_channel=1, stride=1):
        ...
        self.head = nn.Sequential(
            ...
            ConvBNReLU2D(embed_dim, out_channels=embed_dim, kernel_size=3, act="PReLU", padding=1, stride=stride),
        )
